...
class SierraPatronApi_v40 {
  ...
  listCheckoutsForPatron(idOrUrl, { limit, offset, fields } = {}) {
    fields = qsUtils.joinArray(fields)
  ...
  listFinesForPatron(idOrUrl, { limit, offset, fields, assessedDate } = {}) {
  ...
  listHoldsForPatron(idOrUrl, { limit, offset, fields } = {}) {
    fields = qsUtils.joinArray(fields)
